...
This scraper extracts job listings for **CRIS-TIM FAMILY HOLDING SA** (CIF: 13533870) from
the company's own careers site, validates the company via ANAF, and imports
the jobs to peviitor.ro.

Targets: https://cariere.cristim.ro/, 
...
- **Cris-Tim — listing**: `https://cariere.cristim.ro/` — pagina publică de posturi deschise
- **Cris-Tim — sitemap**: `` — permalink-uri canonice
