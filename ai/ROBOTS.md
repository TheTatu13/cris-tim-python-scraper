...
Fill this in per derived company. Check `https://cristim.ro/robots.txt` before the
...
| Path | Role |
|---|---|
| `https://cariere.cristim.ro/` | Public list of open positions (server-rendered HTML) |
| `` | Job sitemap — canonical `https://cariere.cristim.ro/cariere/<slug>/` permalinks |
| `https://cariere.cristim.ro/cariere/<slug>/` | Individual job pages (only referenced, not fully crawled) |
